...
<head>
   ...
   <!-- fevicon -->
   <link rel="icon" href="<?php bloginfo('template_directory') ?>/images/fevicon.png" type="image/gif" />
...
<body class="main-layout">
   <!-- loader  -->
   <div class="loader_bg">
      <div class="loader"><img src="<?php bloginfo('template_directory') ?>/images/loading.gif" alt="#" /></div>
   </div>
   <!-- end loader -->
   <!-- header -->
   <div class="header">
         ...
         <div class="row d_flex">
            <div class=" col-md-2 col-sm-3 col logo_section">
               <div class="full">
                  <div class="center-desk">
                     <div class="logo">
                        <a href="<?php bloginfo('template_directory') ?>/index.html"><img src="<?php bloginfo('template_directory') ?>/images/logo.png" alt="#" /></a>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="collapse navbar-collapse" id="navbarsExample04">
                     <ul class="navbar-nav mr-auto">
                        <li class="nav-item active">
                           <a class="nav-link" href="<?php bloginfo('template_directory') ?>/index.html">Home</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="<?php bloginfo('template_directory') ?>/about.html">About</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="<?php bloginfo('template_directory') ?>/hosting.html">Hosting</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" href="<?php bloginfo('template_directory') ?>/domain.html">Domain</a>
                        </li>

                        <li class="nav-item">
                           <a class="nav-link" href="<?php bloginfo('template_directory') ?>/contact">Contact Us</a>
                        </li>
                     </ul>
                  </div>
               </nav>
            ...
            <div class="col-md-2  d_none">
               <ul class="email text_align_right">
                  <li><a href="<?php bloginfo('template_directory') ?>Javascript:void(0)"> <i class="fa fa-shopping-bag" aria-hidden="true"> <span>0</span></i>
                     </a>
                  </li>
                  <li><a href="<?php bloginfo('template_directory') ?>Javascript:void(0)">Sign In
                     </a>
                  </li>
               </ul>
            </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div id="banner1" class="carousel slide">
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="dream">
                                       ...
                                       <a class="read_more" href="<?php bloginfo('template_directory') ?>Javascript:void(0)">Get Stared</a>
                                       <a class="read_more" href="<?php bloginfo('template_directory') ?>Javascript:void(0)">Contact Us</a>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="dream_img">
                                       <figure><img src="<?php bloginfo('template_directory') ?>/images/dream_img.png" alt="#" /></figure>
                                    </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     <!-- controls -->
                     <a class="carousel-control-prev" href="<?php bloginfo('template_directory') ?>#banner1" role="button" data-slide="prev">
                        <i class="fa fa-arrow-left" aria-hidden="true"></i>
                        <span class="sr-only">Previous</span>
                     </a>
                     <a class="carousel-control-next" href="<?php bloginfo('template_directory') ?>#banner1" role="button" data-slide="next">
         ...
         <div class="row">
            <div class="col-md-10 offset-md-1">
               <div class="form">
                  <div class="searchbar">
                     ...
                     <a href="<?php bloginfo('template_directory') ?>#" class="search_icon"><i class="fa fa-search" aria-hidden="true"></i>
                     </a>
                  </div>
               </div>
            </div>
            <div class="col-md-10 offset-md-1">
               <div class="domain_bg">
                  ...
                  <a class="read_more" href="<?php bloginfo('template_directory') ?>domain.html">See More</a>
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-lg-3 col-md-6">
               <div id="ho_co" class="guarantee-box_main">
                  ...
                  <a class="read_more" href="<?php bloginfo('template_directory') ?>hosting.html">Read More</a>
               </div>
            </div>
            <div class="col-lg-3 col-md-6">
               <div id="ho_co" class="guarantee-box_main">
            ...
            <div class="col-lg-3 col-md-6">
               <div id="ho_co" class="guarantee-box_main">
                  <div class="guarantee-box text_align_center">
                     <i>
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve" height="80pt" width="80pt">
                           <g>
                              <g>
                                 <g>
            ...
            <div class="col-md-4">
               <div id="ho_co" class="order-box_main">
                  <div class="order-box text_align_center">
                     ...
                     <a href="<?php bloginfo('template_directory') ?>Javascript:void(0)">Personal use</a>
                     <ul class="supp">
                  ...
                  <a class="read_more" href="<?php bloginfo('template_directory') ?>Javascript:void(0)">Buy Now</a>
               </div>
            </div>
            <div class="col-md-4">
               <div id="ho_co" class="order-box_main">
         ...
         <div class="row">
            ...
            <div class="col-md-10 offset-md-1">
               <div class="about_img text_align_center">
                  <figure><img src="<?php bloginfo('template_directory') ?>/images/about.png" alt="#" /></figure>
                  <p>
                  ...
                  <a class="read_more" href="<?php bloginfo('template_directory') ?>Javascript:void(0)">Read More</a>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="footer">
               ...
               <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="infoma">
                     ...
                     <ul class="conta">
                        ...
                        <li> <i class="fa fa-envelope" aria-hidden="true"></i><a href="<?php bloginfo('template_directory') ?>Javascript:void(0)"> Email : demo@gmail.com</a></li>
                     </ul>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6 col-sm-6">
                  <div class="infoma">
                     ...
                     <ul class="menu_footer">
                        ...
                        <li><a href="<?php bloginfo('template_directory') ?>domain.html">Domain</a></li>
                        <li><a href="<?php bloginfo('template_directory') ?>hosting.html">Hosting</a></li>
         ...
         <div class="copyright">
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     <p>© 2020 All Rights Reserved. <a href="<?php bloginfo('template_directory') ?>https://html.design/"> Free html Templates</a></p>
                  </div>
               </div>
            </div>
         </div>
